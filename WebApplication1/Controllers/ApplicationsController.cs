...
namespace URC.Controllers
{
    public class ApplicationsController : Controller
    {
        ...
        // A list of student summary objects
        private List<StudentSummary> summaries = new List<StudentSummary>();
        public ApplicationsController(URC_Context context)
        {
            _context = context;
        }
        /*
        ...
        public async Task<IActionResult> Create([Bind("ID,Skills,Resume,Interests,GraduationDate,CompletedCourses,DegreePlan,UID,Email,GPA,Statement,DateCreated,TimeModified")] Application application)
        {
